...
public static class WorldWithPolymorphism_MsDi
{
  ...
  public static void ShouldResolveTwoSimilarObjectGraphsWithDifferentLeavesFromContainerModulesUsingMsDi()
  {
    ...
    WorldWithPolymorphism_MsDi.SoldierMsDiModule<LongSword, ChainMail>.RegisterIn(builder, "hero");
    WorldWithPolymorphism_MsDi.SoldierMsDiModule<ShortSword, BreastPlate>.RegisterIn(builder, "enemy");
